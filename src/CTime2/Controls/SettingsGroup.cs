...
namespace CTime2.Controls
{
    ...
    public class SettingsGroup : Control
    {
        public static readonly DependencyProperty HeaderProperty = DependencyProperty.Register(
            "Header", typeof(string), typeof(SettingsGroup), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty DescriptionProperty = DependencyProperty.Register(
            "Description", typeof(string), typeof(SettingsGroup), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty SettingsProperty = DependencyProperty.Register(
            "Settings", typeof(IList<SettingsItem>), typeof(SettingsGroup), new PropertyMetadata(default(IList<SettingsItem>)));
